...
{
    class EnemyAngryGoblin final : public IEnemy
    {
    public:
        EnemyAngryGoblin() = default;
        ~EnemyAngryGoblin() override = default;
    ...
    private:
        ...
        std::string m_szBaseFile{ "assets/sprites/Enemy/Goblin_2/" };
        ...
        float     m_nMaxHP{ 300.0f };
        float     m_nHealth{ 300.0f };
        float     m_nMoveSpeedUPS{ 3.5f };
        float     m_nDamage{ 21.f };
